...
A:Using it, you can mannually control you stack allocation to avoid "stack over flow". It can be used for function calling that never leads to stackful coroutines switching then the function call do not cost stack of current coroutine. It is also useful for deep recursive calling like regular expressions analysis. 
