...
struct member_function_wrapper<R (C::*)(MACRO_JOIN(RECURSIVE_FUNC_,i)(define_types_begin, define_types, define_types_end)) >{ \
	...
	static R exec( MACRO_JOIN(RECURSIVE_FUNC_,i)(define_pure_typeargs_begin, define_pure_typeargs, define_pure_typeargs) const member_function_wrapper& instance){ \
