...
#define REC_FUNC1_0(i, xyfunc) 
#define REC_FUNC1_1(i, xyfunc) REC_FUNC1_0(i, xyfunc) xyfunc(i, 1)
#define REC_FUNC1_2(i, xyfunc) REC_FUNC1_1(i, xyfunc) xyfunc(i, 2)
#define REC_FUNC1_3(i, xyfunc) REC_FUNC1_2(i, xyfunc) xyfunc(i, 3)
#define REC_FUNC1_4(i, xyfunc) REC_FUNC1_3(i, xyfunc) xyfunc(i, 4)
#define REC_FUNC1_5(i, xyfunc) REC_FUNC1_4(i, xyfunc) xyfunc(i, 5)
#define REC_FUNC1_6(i, xyfunc) REC_FUNC1_5(i, xyfunc) xyfunc(i, 6)
#define REC_FUNC1_7(i, xyfunc) REC_FUNC1_6(i, xyfunc) xyfunc(i, 7)
#define REC_FUNC1_8(i, xyfunc) REC_FUNC1_7(i, xyfunc) xyfunc(i, 8)
#define REC_FUNC1_9(i, xyfunc) REC_FUNC1_8(i, xyfunc) xyfunc(i, 9)
#define REC_FUNC1_10(i, xyfunc) REC_FUNC1_9(i, xyfunc) xyfunc(i, 10)

#define CONCAT_FUNC1(i, j, k) MACRO_JOIN(REC_FUNC1_, i)(j, k)

#define BI_TWO_BATCH_FUNC11(i, xyfunc) BI_ONE_BATCH_FUNC1(CONCAT_FUNC1, i, xyfunc)
...
#define define_rtypes(i) typename function_property<F>::MACRO_JOIN(type,i),
#define define_rtypes_end(i) typename function_property<F>::MACRO_JOIN(type,i)
...
#define define_type_args_ex_end(i) define_type_args_ex(i)

#define define_type_args_ex_c_begin(i)
#define define_type_args_ex_c(i)   MACRO_JOIN(tt,i) MACRO_JOIN(aa,i),
#define define_type_args_ex_c_end(i) MACRO_JOIN(tt,i) MACRO_JOIN(aa,i)
...
#define define_args_ex_c_end(i) define_args_ex_c(i)


#define define_typeargs_c_begin(i)
#define define_typeargs_c(i)   typename function_property<F>::MACRO_JOIN(type,i) MACRO_JOIN(a,i), 
#define define_typeargs_c_end(i) typename function_property<F>::MACRO_JOIN(type,i) MACRO_JOIN(a,i)

#define define_typeargs_begin(i)
#define define_typeargs(i)  , typename function_property<F>::MACRO_JOIN(type,i) MACRO_JOIN(a,i) 
#define define_typeargs_end(i) define_typeargs(i)
...
#define STATIC_ASSERTER(name, value) typedef typename static_asserter<value>::type name;
